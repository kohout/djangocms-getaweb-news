...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsItem.content'
        db.alter_column(u'djangocms_news_newsitem', 'content', self.gf('tinymce.models.HTMLField')(null=True))

    def backwards(self, orm):

        # Changing field 'NewsItem.content'
        db.alter_column(u'djangocms_news_newsitem', 'content', self.gf('tinymce.models.HTMLField')(default=''))
