...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsItem.price'
        db.alter_column(u'djangocms_news_newsitem', 'price', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'NewsItem.price'
        db.alter_column(u'djangocms_news_newsitem', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))
