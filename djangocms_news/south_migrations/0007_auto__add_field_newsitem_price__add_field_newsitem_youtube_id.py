...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsItem.price'
        db.add_column(u'djangocms_news_newsitem', 'price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'NewsItem.youtube_id'
        db.add_column(u'djangocms_news_newsitem', 'youtube_id',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsItem.price'
        db.delete_column(u'djangocms_news_newsitem', 'price')

        # Deleting field 'NewsItem.youtube_id'
        db.delete_column(u'djangocms_news_newsitem', 'youtube_id')
