...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsItem.youtube_id'
        db.alter_column(u'djangocms_news_newsitem', 'youtube_id', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'NewsItem.youtube_id'
        db.alter_column(u'djangocms_news_newsitem', 'youtube_id', self.gf('django.db.models.fields.TextField')())
