...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'djangocms_news_newsitem', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=None, unique=True, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsItem.slug'
        db.delete_column(u'djangocms_news_newsitem', 'slug')
