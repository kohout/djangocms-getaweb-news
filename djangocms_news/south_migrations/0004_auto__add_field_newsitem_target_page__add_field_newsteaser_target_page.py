...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsItem.target_page'
        ...
        # Adding field 'NewsTeaser.target_page'
        db.add_column(u'djangocms_news_newsteaser', 'target_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cms.Page']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'NewsTeaser.target_page'
        db.delete_column(u'djangocms_news_newsteaser', 'target_page_id')
