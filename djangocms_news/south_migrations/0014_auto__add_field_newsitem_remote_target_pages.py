...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsItem.remote_target_pages'
        db.add_column(u'djangocms_news_newsitem', 'remote_target_pages',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsItem.remote_target_pages'
        db.delete_column(u'djangocms_news_newsitem', 'remote_target_pages')
