...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsItem.additional_images_pagination'
        db.add_column(u'djangocms_news_newsitem', 'additional_images_pagination',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'NewsItem.additional_images_speed'
        db.add_column(u'djangocms_news_newsitem', 'additional_images_speed',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=3000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsItem.additional_images_pagination'
        db.delete_column(u'djangocms_news_newsitem', 'additional_images_pagination')

        # Deleting field 'NewsItem.additional_images_speed'
        db.delete_column(u'djangocms_news_newsitem', 'additional_images_speed')
